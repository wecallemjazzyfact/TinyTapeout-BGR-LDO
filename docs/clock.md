---
title: Clock :: Quicker, easier and cheaper to make your own chip!
source: https://tinytapeout.com/specs/clock/
snapshot: 2026-07-10
---

[Tiny Tapeout](/) > [Tech specs](/specs/) > Clock
...
The chip uses the [sky130\_ef\_io\_gpiov2\_pad](https://skywater-pdk.readthedocs.io/en/main/contents/libraries/sky130_fd_io/docs/user_guide.html#sky130-fd-io-gpiov2-additional-features) macro for the I/O pads. The documentation specifies a maximum input frequency of 66 MHz. Therefore, we believe that the maximum clock frequency for your designs will be around 66 MHz.
