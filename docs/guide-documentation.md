---
title: Updating your project documentation :: Quicker, easier and cheaper to make your own chip!
source: https://tinytapeout.com/guides/documentation/
snapshot: 2026-07-10
---

[Tiny Tapeout](/) > [Guides](/guides/) > Updating your project documentation
...
| Tiny Tapeout SKY 25b | <https://github.com/TinyTapeout/tinytapeout-sky-25b> |
...
3. You can edit the `info.yaml` (or `docs/info.md`) directly via the GitHub web interface.
   ...
   #### Editing info.yaml directly via the web interface
   ...
   * On the next screen, you can keep the default settings (fork name and description). Just click “Create fork” to continue.
   ...
   #### Confirm the fork settings and create it
...
4. When you commit, start your commit message with “docs(tt\_um\_project\_name):”. For example:
