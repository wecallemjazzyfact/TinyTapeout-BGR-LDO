---
title: Analog Specs :: Quicker, easier and cheaper to make your own chip!
source: https://tinytapeout.com/specs/analog/
snapshot: 2026-07-10
---

[Tiny Tapeout](/) > [Tech specs](/specs/) > Analog Specs
...
The templates include all the eight analog pins, but only the pins that you paid for will be connected to the pads. In addition, the templates also include all the [standard digital pins](/specs/gpio/).
...
| Tile size | Filename | Available power supplies | |
| --- | --- | --- | --- |
| 1.8V (VDPWR) | 3.3V (VAPWR) |
| 1x2 | `tt_analog_1x2.def` | ✅ | ❌ |
| `tt_analog_1x2_3v3.def` | ✅ | ✅ |
| 2x2 | `tt_analog_2x2.def` | ✅ | ❌ |
| `tt_analog_2x2_3v3.def` | ✅ | ✅ |
...
Decide on a name for your module (top cell). The top level module name must start with ’tt\_um\_’, and it must be unique on the shuttle, so we suggest including your github username, e.g. tt\_um\_username\_amazing\_adc.
