---
title: FAQ :: Quicker, easier and cheaper to make your own chip!
source: https://tinytapeout.com/faq/
snapshot: 2026-07-10
---
...
#### Availability of analog slots on TTSky26a

An analog *project* can take up a maximum of two analog slots - therefore valid sizes for analog projects are either 1x2
...
* [re-run the github action](/faq/#i-updated-and-saved-my-wokwi-design-how-do-i-re-run-the-github-action-to-update-the-gds-files).
...
You can familiarise yourself with the license at [<http://www.apache.org/licenses/LICENSE-2.0>](http://www.apache.org/licenses/LICENSE-2.0).
...
You are encouraged to research more about open-source licenses - visit [<https://choosealicense.com/>](https://choosealicense.com/).
...
#### Rerunning the GDS action via the Actions tab
...
* src - the source files for your chip:
  + user\_module\_xxxxx.v the [Verilog](https://www.zerotoasiccourse.com/terminology/hdl/) file that represents your Wokwi design.
