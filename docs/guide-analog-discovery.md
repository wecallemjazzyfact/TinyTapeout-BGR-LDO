---
title: Interacting with projects and making measurements with the Analog Discovery :: Quicker, easier and cheaper to make your own chip!
source: https://tinytapeout.com/guides/analog-discovery/
snapshot: 2026-07-10
---

[Tiny Tapeout](/) > [Guides](/guides/) > Interacting with projects and making measurements with the Analog Discovery

# Interacting with projects and making measurements with the Analog Discovery
...
2. The [tt05analogdemoFull.dwf3work](/guides/analog-discovery/tt05analogdemoFull.dwf3work) workspace opened in *WaveForms*;
...
* Set the input bits so that the ring oscillator is on, using the *input\_byte* to set all the bits in one go
...
#### AD3 DIO and Core Supply connections

With everything wired up, setting all the signals to 1 and the DACCtrl to 7 – so all configured bits high – and pressing Run should set the bits on the input, and this may be checked by outputting the current state of the input\_byte in the REPL
...
#### Reading AD3 DIO from demoboard
...
#### Reading frequency measurement from the scripting engine
...
#### Characterizing frequency vs core V
