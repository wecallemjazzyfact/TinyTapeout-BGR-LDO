---
title: Pinouts :: Quicker, easier and cheaper to make your own chip!
source: https://tinytapeout.com/specs/pinouts/
snapshot: 2026-07-10
---

[Tiny Tapeout](/) > [Tech specs](/specs/) > Pinouts
...
uio\_out[7] or uo\_out[7] - Audio Output

For stereo audio output, we recommend using pins 6 and 7 with the following convention:

uio\_out[6] or uo\_out[6] - Left Channel  
uio\_out[7] or uo\_out[7] - Right Channel
