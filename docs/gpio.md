---
title: GPIO pins :: Quicker, easier and cheaper to make your own chip!
source: https://tinytapeout.com/specs/gpio/
snapshot: 2026-07-10
---

[Tiny Tapeout](/) > [Tech specs](/specs/) > GPIO pins
...
Internally, both the `clk` and `rst_n` pins are handled like any other input pins. However, they have special meaning to the [Tiny Tapeout demo board](/specs/pcb/). For more information on the `clk` pin and input synchronization, see the [Clock](/specs/clock/) section.

### Limitations

The chip uses the [sky130\_ef\_io\_gpiov2\_pad](https://skywater-pdk.readthedocs.io/en/main/contents/libraries/sky130_fd_io/docs/user_guide.html#sky130-fd-io-gpiov2-additional-features) macro for the I/O pads. The documentation lists the following limitations:
