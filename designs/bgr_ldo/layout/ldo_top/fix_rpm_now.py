...
사용:
  magic:  load ldo_top ; drc style drc(full) ; drc euclidean on ; gds write ldo_top_now.gds
  shell:  python3 fix_rpm.py
  제출/검증은 모두 ldo_top_now_fixed.gds 기준
"""
import gdstk

SRC, DST, TOP = "ldo_top_now.gds", "ldo_top_now_fixed.gds", "ldo_top"
